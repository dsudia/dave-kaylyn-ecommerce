...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('products').insert({name: 'Black Oxford', color: 'black', image_file: 'images/mens-oxfords-black.jpg', price: 99.99, gender: 'm'}),
    knex('products').insert({name: 'Hip Sneaks', color: 'blue', image_file: 'images/mens-sneaker-blue.jpg', price: 39.99, gender: 'm'})
  );
};
