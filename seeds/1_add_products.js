...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('table_name').insert({name: 'Black Oxford', color: 'black', image_file: 'images/mens-oxfords-black.png', price: 99.99, gender: 'm'}),
    knex('table_name').insert({name: 'Hip Sneaks', color: 'blue', image_file: 'images/mens-sneaker-blue.png', price: 39.99, gender: 'm'})
  );
};
